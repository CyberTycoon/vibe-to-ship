...
1. Pair once: `node cli/openlotus.mjs pair --email you@example.com --password ... --project <id>`
...
3. Restart the client — four tools appear under the `openlotus` server.
...
openlotus pair --email founder@company.com --password ... --project <id> --base-url https://app.openlotus.dev
